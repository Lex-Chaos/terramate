...
func GetCommit(_ *cloudstore.Data, w http.ResponseWriter, _ *http.Request, _ httprouter.Params) {
	w.Header().Add("Content-Type", "application/json")
	writeString(w, getCommitResponse)
}

// GetPullRequest returns a pull request.
func GetPullRequest(_ *cloudstore.Data, w http.ResponseWriter, _ *http.Request, _ httprouter.Params) {
	w.Header().Add("Content-Type", "application/json")
	writeString(w, getPullRequestResponse)
}
